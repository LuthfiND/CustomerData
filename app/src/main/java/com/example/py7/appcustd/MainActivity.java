...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    View dialogView;
    TextView Tv_Nomor, Tv_Nama, Tv_Paket, Tv_Tanggal, Tv_Alamat;
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        ...
                        Tv_Paket = (TextView)dialogView.findViewById(R.id.tv_Paket);
                        ...
                        Tv_Tanggal.setText("Tanggal Pemasangan: " + cur.getString(cur.getColumnIndex(DBHelper.row_tglLahir)));
                        Tv_Paket.setText("Paket: " + cur.getString(cur.getColumnIndex(DBHelper.row_paket)));
